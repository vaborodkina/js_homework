...
// prettier-ignore
5 &&"qwerty" //qwerty -> && returns 1st "false", as 5 is true and qwerty is true,- it returns the last value 

+'40' + +'2' + "hillel"; //42hillel -> 40+2 and concatenation
...
// prettier-ignore
0 || '0' && 1 //1 -> && has the priority on the || -> 0 || ('0' && 1) -> 0 || 1

(+null == false) < 1; //false -> false == 0; true == 1 -> (0 == 0) <1 -> 1<1
