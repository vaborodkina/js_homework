const min = 100; //ліва границя включно
const max = 1000; //права границя включно
...
function checkProbabilityTheory(count) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    console.log("Рандомне число: " + randomNum); // Виведе рандомне число число від 100 до 1000
    if (randomNum % 2 === 0) {
      counterEven++;
    } else {
      counterOdd++;
